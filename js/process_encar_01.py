...
fuels = [(norm(x), len(df_encar[df_encar.fuel == x].index))
         for x in df_encar.fuel.unique()]
transmissions = [(norm(x), len(df_encar[df_encar.transmission == x].index))
                 for x in df_encar.transmission.unique()]
colors = [(norm(x), len(df_encar[df_encar.color == x]))
          for x in df_encar.color.unique()]
titles = [(norm(x), len(df_encar[df_encar.title == x]))
          for x in df_encar.title.unique()]
model_years = [(norm(x), len(df_encar[df_encar.model_year == x]))
               for x in df_encar.model_year.unique()]
registereds = [(norm(x), len(df_encar[df_encar.registered == x]))
               for x in df_encar.registered.unique()]
